...
#define TYPE_FORMAT_STRING_SIZE   2285                              
#define PROC_FORMAT_STRING_SIZE   3469                              
...
/* 2524 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */

	/* Parameter pPercentDeadband */

/* 2526 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 2528 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 2530 */	NdrFcShort( 0x79c ),	/* Type Offset=1948 */

	/* Parameter ppErrors */

/* 2532 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2534 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 2536 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 2578 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */
...
/* 2632 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */
...
/* 2638 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */

	/* Parameter ppdwRevisedSamplingRate */

/* 2640 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2642 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 2644 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */

	/* Parameter ppErrors */

/* 2646 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2648 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 2650 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 2672 */	0x47,		/* Oi2 Flags:  srv must size, clt must size, has return, has ext, */
			0x5,		/* 5 */
/* 2674 */	0x8,		/* 8 */
			0x7,		/* Ext Flags:  new corr desc, clt corr check, srv corr check, */
...
/* 2692 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */

	/* Parameter ppdwSamplingRate */

/* 2694 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2696 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 2698 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */

	/* Parameter ppErrors */

/* 2700 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2702 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 2704 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 2800 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */

	/* Parameter ppbEnable */

/* 2802 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2804 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 2806 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */

	/* Parameter ppErrors */

/* 2808 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2810 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 2812 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 2854 */	NdrFcShort( 0x7b4 ),	/* Type Offset=1972 */
...
/* 2872 */	NdrFcShort( 0x6f6 ),	/* Type Offset=1782 */

	/* Parameter ppItemProperties */

/* 2874 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 2876 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 2878 */	NdrFcShort( 0x7d4 ),	/* Type Offset=2004 */

	/* Return value */

/* 2880 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 2882 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 2884 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 2892 */	NdrFcShort( 0x4 ),	/* 4 */
/* 2894 */	NdrFcShort( 0x3c ),	/* x86 Stack size/offset = 60 */
/* 2896 */	NdrFcShort( 0x26 ),	/* 38 */
/* 2898 */	NdrFcShort( 0x40 ),	/* 64 */
...
/* 2916 */	NdrFcShort( 0x201b ),	/* Flags:  must size, must free, in, out, srv alloc size=8 */
/* 2918 */	NdrFcShort( 0x8 ),	/* x86 Stack size/offset = 8 */
/* 2920 */	NdrFcShort( 0x34 ),	/* Type Offset=52 */
...
/* 2938 */	NdrFcShort( 0x4 ),	/* Type Offset=4 */
...
/* 2944 */	NdrFcShort( 0x4 ),	/* Type Offset=4 */

	/* Parameter bReturnAllProperties */

/* 2946 */	NdrFcShort( 0x48 ),	/* Flags:  in, base type, */
/* 2948 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 2950 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 2954 */	NdrFcShort( 0x20 ),	/* x86 Stack size/offset = 32 */
/* 2956 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 2960 */	NdrFcShort( 0x24 ),	/* x86 Stack size/offset = 36 */
/* 2962 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 2966 */	NdrFcShort( 0x28 ),	/* x86 Stack size/offset = 40 */
/* 2968 */	NdrFcShort( 0x83a ),	/* Type Offset=2106 */
...
/* 2978 */	NdrFcShort( 0x30 ),	/* x86 Stack size/offset = 48 */
/* 2980 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 2986 */	NdrFcShort( 0x846 ),	/* Type Offset=2118 */

	/* Return value */

/* 2988 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 2990 */	NdrFcShort( 0x38 ),	/* x86 Stack size/offset = 56 */
/* 2992 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 3002 */	NdrFcShort( 0x24 ),	/* x86 Stack size/offset = 36 */
...
/* 3028 */	NdrFcShort( 0x7b4 ),	/* Type Offset=1972 */

	/* Parameter pdwMaxAge */

/* 3030 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 3032 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 3034 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */

	/* Parameter ppvValues */

/* 3036 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 3038 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 3040 */	NdrFcShort( 0x87e ),	/* Type Offset=2174 */
...
/* 3046 */	NdrFcShort( 0x89c ),	/* Type Offset=2204 */

	/* Parameter ppftTimeStamps */

/* 3048 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 3050 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 3052 */	NdrFcShort( 0x8a4 ),	/* Type Offset=2212 */

	/* Parameter ppErrors */

/* 3054 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 3056 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 3058 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 3080 */	0x47,		/* Oi2 Flags:  srv must size, clt must size, has return, has ext, */
			0x5,		/* 5 */
/* 3082 */	0x8,		/* 8 */
			0x7,		/* Ext Flags:  new corr desc, clt corr check, srv corr check, */
...
/* 3100 */	NdrFcShort( 0x7b4 ),	/* Type Offset=1972 */

	/* Parameter pItemVQT */

/* 3102 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 3104 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 3106 */	NdrFcShort( 0x8d6 ),	/* Type Offset=2262 */

	/* Parameter ppErrors */

/* 3108 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 3110 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 3112 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 3126 */	NdrFcShort( 0x5 ),	/* 5 */
/* 3128 */	NdrFcShort( 0x24 ),	/* x86 Stack size/offset = 36 */
/* 3130 */	NdrFcShort( 0x8 ),	/* 8 */
/* 3132 */	NdrFcShort( 0x8 ),	/* 8 */
/* 3134 */	0x47,		/* Oi2 Flags:  srv must size, clt must size, has return, has ext, */
			0x8,		/* 8 */
/* 3136 */	0x8,		/* 8 */
			0x7,		/* Ext Flags:  new corr desc, clt corr check, srv corr check, */
...
/* 3206 */	0x47,		/* Oi2 Flags:  srv must size, clt must size, has return, has ext, */
			0x5,		/* 5 */
/* 3208 */	0x8,		/* 8 */
			0x7,		/* Ext Flags:  new corr desc, clt corr check, srv corr check, */
...
/* 3226 */	NdrFcShort( 0x4f8 ),	/* Type Offset=1272 */

	/* Parameter pItemVQT */

/* 3228 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 3230 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 3232 */	NdrFcShort( 0x8d6 ),	/* Type Offset=2262 */

	/* Parameter ppErrors */

/* 3234 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 3236 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 3238 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 3302 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 3304 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */

	/* Return value */

/* 3306 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 3308 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 3310 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 3320 */	NdrFcShort( 0x20 ),	/* x86 Stack size/offset = 32 */
/* 3322 */	NdrFcShort( 0x10 ),	/* 16 */
/* 3324 */	NdrFcShort( 0x24 ),	/* 36 */
/* 3326 */	0x47,		/* Oi2 Flags:  srv must size, clt must size, has return, has ext, */
			0x7,		/* 7 */
/* 3328 */	0x8,		/* 8 */
			0x7,		/* Ext Flags:  new corr desc, clt corr check, srv corr check, */
...
/* 3366 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 3368 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 3370 */	NdrFcShort( 0x52c ),	/* Type Offset=1324 */
...
/* 3384 */	NdrFcShort( 0xb ),	/* 11 */
/* 3386 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 3388 */	NdrFcShort( 0x10 ),	/* 16 */
...
/* 1952 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x0,		/*  */
...
/* 1964 */	
			0x13, 0x0,	/* FC_OP */
/* 1966 */	NdrFcShort( 0xffee ),	/* Offset= -18 (1948) */
/* 1968 */	
			0x11, 0x0,	/* FC_RP */
...
/* 1980 */	NdrFcShort( 0x1 ),	/* Corr flags:  early, */
/* 1982 */	
			0x4b,		/* FC_PP */
			0x5c,		/* FC_PAD */
/* 1984 */	
...
/* 1996 */	0x12, 0x8,	/* FC_UP [simple_pointer] */
/* 1998 */	
			0x25,		/* FC_C_WSTRING */
			0x5c,		/* FC_PAD */
/* 2000 */	
...
/* 2008 */	
			0x13, 0x0,	/* FC_OP */
/* 2010 */	NdrFcShort( 0x46 ),	/* Offset= 70 (2080) */
/* 2012 */	
			0x1a,		/* FC_BOGUS_STRUCT */
			0x3,		/* 3 */
/* 2014 */	NdrFcShort( 0x28 ),	/* 40 */
/* 2016 */	NdrFcShort( 0x0 ),	/* 0 */
/* 2018 */	NdrFcShort( 0xe ),	/* Offset= 14 (2032) */
/* 2020 */	0x6,		/* FC_SHORT */
			0x6,		/* FC_SHORT */
/* 2022 */	0x8,		/* FC_LONG */
			0x36,		/* FC_POINTER */
/* 2024 */	0x36,		/* FC_POINTER */
			0x4c,		/* FC_EMBEDDED_COMPLEX */
/* 2026 */	0x0,		/* 0 */
			NdrFcShort( 0xfccd ),	/* Offset= -819 (1208) */
			0x8,		/* FC_LONG */
/* 2030 */	0x8,		/* FC_LONG */
			0x5b,		/* FC_END */
/* 2032 */	
...
/* 2056 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2058 */	NdrFcShort( 0xffd2 ),	/* Offset= -46 (2012) */
/* 2060 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 2062 */	
			0x1a,		/* FC_BOGUS_STRUCT */
...
/* 2068 */	NdrFcShort( 0x8 ),	/* Offset= 8 (2076) */
/* 2070 */	0x8,		/* FC_LONG */
			0x8,		/* FC_LONG */
...
/* 2076 */	
			0x13, 0x0,	/* FC_OP */
/* 2078 */	NdrFcShort( 0xffda ),	/* Offset= -38 (2040) */
/* 2080 */	
			0x21,		/* FC_BOGUS_ARRAY */
			0x3,		/* 3 */
/* 2082 */	NdrFcShort( 0x0 ),	/* 0 */
/* 2084 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x0,		/*  */
/* 2086 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 2088 */	NdrFcShort( 0x1 ),	/* Corr flags:  early, */
/* 2090 */	NdrFcLong( 0xffffffff ),	/* -1 */
/* 2094 */	NdrFcShort( 0x0 ),	/* Corr flags:  */
/* 2096 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2098 */	NdrFcShort( 0xffdc ),	/* Offset= -36 (2062) */
/* 2100 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 2102 */	
			0x11, 0x0,	/* FC_RP */
...
/* 2110 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x0,		/*  */
/* 2112 */	NdrFcShort( 0x24 ),	/* x86 Stack size/offset = 36 */
...
/* 2122 */	
			0x13, 0x0,	/* FC_OP */
/* 2124 */	NdrFcShort( 0x1c ),	/* Offset= 28 (2152) */
/* 2126 */	
			0x1a,		/* FC_BOGUS_STRUCT */
			0x3,		/* 3 */
/* 2128 */	NdrFcShort( 0x20 ),	/* 32 */
/* 2130 */	NdrFcShort( 0x0 ),	/* 0 */
/* 2132 */	NdrFcShort( 0xc ),	/* Offset= 12 (2144) */
...
/* 2138 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2140 */	NdrFcShort( 0xffb2 ),	/* Offset= -78 (2062) */
/* 2142 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 2144 */	
			0x13, 0x8,	/* FC_OP [simple_pointer] */
...
/* 2156 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x54,		/* FC_DEREFERENCE */
/* 2158 */	NdrFcShort( 0x30 ),	/* x86 Stack size/offset = 48 */
/* 2160 */	NdrFcShort( 0x1 ),	/* Corr flags:  early, */
/* 2162 */	NdrFcLong( 0xffffffff ),	/* -1 */
/* 2166 */	NdrFcShort( 0x0 ),	/* Corr flags:  */
/* 2168 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2170 */	NdrFcShort( 0xffd4 ),	/* Offset= -44 (2126) */
/* 2172 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 2174 */	
			0x11, 0x14,	/* FC_RP [alloced_on_stack] [pointer_deref] */
...
/* 2186 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x0,		/*  */
/* 2188 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 2190 */	NdrFcShort( 0x1 ),	/* Corr flags:  early, */
/* 2192 */	NdrFcLong( 0xffffffff ),	/* -1 */
/* 2196 */	NdrFcShort( 0x0 ),	/* Corr flags:  */
/* 2198 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2200 */	NdrFcShort( 0xfc20 ),	/* Offset= -992 (1208) */
/* 2202 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 2204 */	
			0x11, 0x14,	/* FC_RP [alloced_on_stack] [pointer_deref] */
...
/* 2208 */	
			0x13, 0x0,	/* FC_OP */
/* 2210 */	NdrFcShort( 0xfd86 ),	/* Offset= -634 (1576) */
/* 2212 */	
			0x11, 0x14,	/* FC_RP [alloced_on_stack] [pointer_deref] */
/* 2214 */	NdrFcShort( 0x2 ),	/* Offset= 2 (2216) */
/* 2216 */	
			0x13, 0x0,	/* FC_OP */
...
/* 2230 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2232 */	NdrFcShort( 0xf798 ),	/* Offset= -2152 (80) */
/* 2234 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 2236 */	
			0x11, 0x0,	/* FC_RP */
/* 2238 */	NdrFcShort( 0x18 ),	/* Offset= 24 (2262) */
/* 2240 */	
			0x1a,		/* FC_BOGUS_STRUCT */
			0x3,		/* 3 */
...
/* 2248 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2250 */	NdrFcShort( 0xfc42 ),	/* Offset= -958 (1292) */
/* 2252 */	0x8,		/* FC_LONG */
			0x6,		/* FC_SHORT */
/* 2254 */	0x6,		/* FC_SHORT */
			0x8,		/* FC_LONG */
/* 2256 */	0x8,		/* FC_LONG */
			0x4c,		/* FC_EMBEDDED_COMPLEX */
/* 2258 */	0x0,		/* 0 */
			NdrFcShort( 0xf77d ),	/* Offset= -2179 (80) */
			0x5b,		/* FC_END */
/* 2262 */	
			0x21,		/* FC_BOGUS_ARRAY */
			0x3,		/* 3 */
/* 2264 */	NdrFcShort( 0x0 ),	/* 0 */
/* 2266 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x0,		/*  */
...
/* 2278 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 2280 */	NdrFcShort( 0xffd8 ),	/* Offset= -40 (2240) */
/* 2282 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
